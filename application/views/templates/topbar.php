 ...
 <div id="content-wrapper" class="d-flex flex-column">
     ...
     <div id="content">
         ...
         <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
             ...
             <h4 class="lead text-gray-800 d-none d-lg-block ml-3 mt-2">Sistem informasi Pembayaran SPP Metode Payment GATEWAY <span class="badge badge-info">Prototype</span></h4>
